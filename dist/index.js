...
(() => {
  ...
  function autoTabs() {
    if (navigator.userAgent.includes("Safari")) {
      document.querySelectorAll(".home-competitions_tab-link").forEach((t) => {
        const tabButton = t;
  ...
  function rewardsAnim() {
    gsapWithCSS.set(".home-rewards_image-cards-back, .home-rewards_image-question-back", { rotationY: -90 });
    gsapWithCSS.set(".home-rewards_image-cards-front, .home-rewards_image-question-front", {
      rotationY: -90
    });
