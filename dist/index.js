...
(() => {
  ...
  function mirrorHero() {
    ...
    function setupClickEvent(triggerSelector, targetSelector) {
      const trigger = document.querySelector(triggerSelector);
      const target = document.querySelector(targetSelector);
      if (!trigger || !target) {
        console.error(
          `Les \xE9l\xE9ments avec les s\xE9lecteurs ${triggerSelector} et ${targetSelector} ne sont pas trouv\xE9s dans le document.`
        );
        return;
      }
  ...
  // node_modules/.pnpm/gsap@3.12.3/node_modules/gsap/Observer.js
  ...
  // node_modules/.pnpm/gsap@3.12.3/node_modules/gsap/ScrollTrigger.js
  var gsap3;
  var _coreInitted3;
  var _win4;
  var _doc4;
  ...
  function cardsAnim() {
    ...
    const stagger = window.innerWidth <= 768 ? 2 : 1;
    gsapWithCSS.set(".home-cards_cards-img-front", { scale: 0.3, rotation: 0 });
    gsapWithCSS.to(".home-cards_cards-img-front", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.set(".home-cards_cards-img-front", { rotationY: 0 });
    gsapWithCSS.set(".home-cards_cards-img-back", { rotationY: 90 });
    gsapWithCSS.to(".home-cards_cards-img-front", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home-cards",
    ...
    gsapWithCSS.to(".home-cards_cards-img-back", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home-cards",
        start: "8% 25%",
  ...
  function simpleAnim() {
    gsapWithCSS.set(".home-simple_cards-w.is-simple", { rotationX: 0, opacity: 1 });
    gsapWithCSS.set(".home-simple_cards-w.is-fun", { rotationX: -90, opacity: 0 });
    gsapWithCSS.set(".home-simple_cards-w.is-quotidien", { rotationX: -90, opacity: 0 });
    gsapWithCSS.set(".home-simple_cards-w.is-solidaire", { rotationX: -90, opacity: 0 });
    gsapWithCSS.set(".home-simple_stars", { y: "0vh" });
    gsapWithCSS.to(".home-simple_cards-w.is-simple", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".home-simple_cards-w.is-fun", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home-simple",
        start: "25% 75%",
      ...
      onStart: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-fun", { opacity: 1 });
      },
      onReverseComplete: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-fun", { opacity: 0 });
      },
      rotationX: 90,
      duration: 0.5,
      ease: "ease",
    ...
    gsapWithCSS.to(".home-simple_cards-w.is-quotidien", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home-simple",
        start: "50% 75%",
      ...
      onStart: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-quotidien", { opacity: 1 });
      },
      onReverseComplete: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-quotidien", { opacity: 0 });
      },
      rotationX: 90,
      duration: 2,
      ease: "linear",
    ...
    gsapWithCSS.to(".home-simple_cards-w.is-solidaire", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home-simple",
        start: "75% 75%",
      ...
      onStart: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-solidaire", { opacity: 1 });
      },
      onReverseComplete: () => {
        gsapWithCSS.set(".home-simple_cards-w.is-solidaire", { opacity: 0 });
      },
      rotationX: 0,
      duration: 2,
      ease: "linear",
    ...
    gsapWithCSS.utils.toArray(".home-simple_stars").forEach((star) => {
  ...
  function rewardsAnim() {
    ...
    const tl2 = gsapWithCSS.timeline({ repeat: -1 });
    ...
    ["is-first", "is-second", "is-third"].forEach((cardClass) => {
      tl2.add(animateCard(`.home-rewards_image-cards-back.${cardClass}`)).add(animateFront(), "-=0");
    });
  }
  function animateCard(selector3) {
    return gsapWithCSS.timeline().to(selector3, {
      rotationY: 90,
      duration: 0.8,
      ease: "linear",
      transformOrigin: "center",
      force3D: true
    }).to(selector3, { rotationY: -90, duration: 0, immediateRender: false });
  }
  function animateFront() {
    return gsapWithCSS.timeline().to(".home-rewards_image-cards-front", {
      rotationY: 0,
      duration: 0.4,
      ease: "linear",
      transformOrigin: "center",
  ...
  function swiperPartnersLine(selector3, reverseDirection) {
    new Swiper(selector3, {
      direction: "horizontal",
      grabCursor: true,
      loop: true,
      slidesPerView: "auto",
  ...
  function fillHiddenFieldsWithUTM() {
  ...
  window.Webflow.push(() => {
    ...
    autoTabs();
    swiperJockeys();
    swiperPartnersLine(".swiper.is-partners-line1", true);
    swiperPartnersLine(".swiper.is-partners-line2", false);
    mirrorHero();
