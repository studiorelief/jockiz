...
(() => {
  ...
  function cardsAnim() {
    gsapWithCSS.set(".home-cards_cards-img-front", { scale: 0, rotation: 0 });
  ...
  function rewardsAnim() {
    gsapWithCSS.set(".home-rewards_image-cards-back", { rotationY: -90 });
    gsapWithCSS.set(".home-rewards_image-cards-front", { rotationY: -90 });
